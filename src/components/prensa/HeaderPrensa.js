            ...
            <nav className="wsmenu clearfix">
              ...
              >
                ...
                <li>
                  ...
                  <Link href="/" className="button-header-submenu">
                  ...
                  {!singlePage && (
                    ...
                    >
                      <li>
                        <a href="/#beneficios" className="submenu-custom-link">Beneficios</a>
                      </li>
                      <li>
                        <a href="/#features" className="submenu-custom-link">Cómo funciona</a>
                      </li>
                    </ul>
                  )}
                </li>
